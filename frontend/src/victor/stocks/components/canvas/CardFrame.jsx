...
/** Shared draggable/resizable card shell (stock cards + portfolio card).
 *  `header` renders inside the drag-handle region; the expand/close buttons
 *  overlay its top-right corner. */
